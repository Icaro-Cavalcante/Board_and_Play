...
def teste_colaborador_create():
    '''Teste para o método create de ColaboradorRepository'''
...
def teste_colaborador_read():
    '''Teste para o método read de ColaboradorRepository'''
    colaborador = colaborador_repo.read(1)
    assert colaborador.id == 1

def teste_colaborador_update():
    '''Teste para o método update de ColaboradorRepository'''
