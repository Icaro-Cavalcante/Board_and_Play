...
def teste_consumivel_create():
    '''Teste para o método create de ConsumivelRepository'''
    # NECESSÁRIO CHECKS PARA CREATE EM APLICAÇÃO, como a tabela produto não tem mais uniques além do id ela pode se repetir com os mesmos dados
...
def teste_consumivel_read():
    '''Teste para o método read de ConsumivelRepository'''
    consumivel = consumivel_repo.read(1)
    assert consumivel.id == 1

def teste_consumivel_update():
    '''Teste para o método update de ConsumivelRepository'''
